...
pylab.grid()
pylab.savefig('./figure/3D_eg_lr_sensor.png', bbox_inches='tight')

pylab.figure(2)
plotlow, = pylab.plot(time, lSensorRec[::stride], '-b', label='Low Sensor')
...
pylab.ylabel('Density of Sensors')
pylab.grid()
pylab.savefig('./figure/3D_eg_lh_sensor.png', bbox_inches='tight')
...
pylab.grid()
pylab.savefig('./figure/3D_eg_lh_dist.png', bbox_inches='tight')
...
pylab.ylabel('Density of Sensors')
pylab.grid()
pylab.savefig('./figure/3D_eg_lr_sensor2.png', bbox_inches='tight')
...
pylab.ylabel('Density of Sensors')
pylab.grid()
pylab.savefig('./figure/3D_eg_lh_sensor2.png', bbox_inches='tight')
...
pylab.ylabel('Distance from source')
pylab.grid()
pylab.savefig('./figure/3D_eg_lh_dist2.png', bbox_inches='tight')
